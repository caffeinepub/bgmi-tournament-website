            ...
            <div className="container mx-auto px-4 py-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-6">
                        <Link to="/tournaments" className="font-saira text-xs tracking-widest uppercase transition-colors hover:text-orange-DEFAULT" style={{ color: 'oklch(0.55 0.02 60)' }}>
                            Tournaments
                        </Link>
                        <Link to="/terms" className="font-saira text-xs tracking-widest uppercase transition-colors hover:text-orange-DEFAULT" style={{ color: 'oklch(0.55 0.02 60)' }}>
                            Terms
                        </Link>
                        <Link to="/login" className="font-saira text-xs tracking-widest uppercase transition-colors hover:text-orange-DEFAULT" style={{ color: 'oklch(0.55 0.02 60)' }}>
                            Login
                        </Link>
                    </div>
